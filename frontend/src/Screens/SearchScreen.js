...
export default function SearchScreen() {
    ...
    const getFilterUrl = (filter) =>{
        ...
        return `/search?category=${filterCategory}&query=${query}}&prix=${filterPrix}&rating=${filterRating}&order=${filterOrder}&page=${filterPage}`
           ...
           <Row className='justify-content-between mb-3'>
            ...
            <Col className='text-end'>
                ...
                >
                    ...
                    <option value="lwest">Prix: Low to High</option>
